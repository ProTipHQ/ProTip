 ...
 *
 * Controls financial.html, the main wallet Chrome popover/Firefox panel
 */
//
...
//         wallet.mulitpleOutputsSend([{txDest: address, txSatoshis: val}], FEE, password).then(function () {
