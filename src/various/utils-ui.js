...
var uiUtils = {
    ...
    initAvailableCurrenciesOptions: function() {
        ...
        this.updateFiatCurrencyCode();
    },
    updateCurrency: function(newCurrencyCode, oldFiatCurrencyCode) {
    ...
    importSubscriptions: function(subscriptionRecords) {
        for(var i in subscriptionRecords){
            db.put('subscriptions', subscriptionRecords[i]);
        }
    },
    updateGlobalOptionsAmount: function(exchangeRateCoeff, newCurrencyCode) {
    ...
    updateFiatCurrencyCode: function() {
    ...
    createQRCodeCanvas: function(text) {
        ...
        var qrcode = new QRCode(typeNumber, errorCorrectionLevel);
        qrcode.addData(text);
        qrcode.make();
