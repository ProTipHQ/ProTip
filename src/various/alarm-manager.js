...
alarmManager.prototype = {
    ...
    setAlarm: function(delayInMinutes) {
        ...
        browser.alarms.getAll().then(function(objs){
            ...
            console.log('New alarm created for ' + date.format());
        });
    },
    listAlarms: function() {
        browser.alarms.getAll().then(function(objs) {
            for (let i=0; i < objs.length; i++) {
                ...
                console.log('Alarm for: ' + date.format());
            }
        });
    },
    ...
    createAlarm: function () {
        ...
        // in one week, with retrys every 1 hour.
        browser.alarms.create(this.alarmName, {
            delayInMinutes: delayInMinutes, periodInMinutes: 60
        });
    },
